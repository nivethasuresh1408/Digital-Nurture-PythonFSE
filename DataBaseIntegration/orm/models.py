...
class Department(Base):
    ...
    head_of_dept = Column(String(100), nullable=False)  # Renamed as per Hands-On 1
...
class Student(Base):
    ...
    # Hands-On 7 Task 2: Incremental Migration column additions
...
# Hands-On 7 Task 2: Added incremental model table structure
